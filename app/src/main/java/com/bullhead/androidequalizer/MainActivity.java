...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String[] titles = {"枫-jay","千山万水-jay", "回到过去-jay","英文歌曲", "浪漫海贝", "清洁耳朵", "溪边虫鸣", "钢琴曲7", "雨打芭蕉"};

    public static final String[] uri = {instanceUriStr(R.raw.f),instanceUriStr(R.raw.qsws), instanceUriStr(R.raw.hdgq),instanceUriStr(R.raw.lenka), instanceUriStr(R.raw.lmhb), instanceUriStr(R.raw.qjed), instanceUriStr(R.raw.xbcm), instanceUriStr(R.raw.gqq7), instanceUriStr(R.raw.ydbj)};
