    ...
    override fun initRun(mAudioEffect: AudioEffect, owner: LifecycleOwner) {
        if (viewModel.environmentalReverbs.isEmpty()) {
            viewModel.environmentalReverbs.apply {
                add(EnableViewModel.EnvironmentalReverbInfo("setDecayHFRatio", maxProx = 2000, startPox = 100, plusSum = -100, position = 0).apply {
                    callMethod = {
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setDecayTime", maxProx = 20000, startPox = 100, plusSum = -100, position = 1).apply {
                    callMethod = {
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setDensity", maxProx = 1000, startPox = 0, plusSum = 0, position = 2).apply {
                    callMethod = {
                        val value = (thisProx - plusSum).toShort()
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setDiffusion", maxProx = 1000, startPox = 0, plusSum = 0, position = 3).apply {
                    callMethod = {
                        val value = (thisProx - plusSum).toShort()
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setReflectionsDelay", maxProx = 300, startPox = 0, plusSum = 0, position = 4).apply {
                    callMethod = {
                        val value = (thisProx - plusSum)
                ...
                add(
                    EnableViewModel.EnvironmentalReverbInfo("setReflectionsLevel", maxProx = 1000, startPox = -9000, plusSum = 9000, position = 5)
                        .apply {
                            callMethod = {
                                val value = (thisProx - plusSum).toShort()
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setReverbDelay", maxProx = 100, startPox = 0, plusSum = 0, position = 6).apply {
                    callMethod = {
                        val value = (thisProx - plusSum)
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setReverbLevel", maxProx = 2000, startPox = -9000, plusSum = 9000, position = 7).apply {
                    callMethod = {
                        val value = (thisProx - plusSum).toShort()
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setRoomHFLevel", maxProx = 0, startPox = -9000, plusSum = 9000, position = 8).apply {
                    callMethod = {
                        val value = (thisProx - plusSum).toShort()
                ...
                add(EnableViewModel.EnvironmentalReverbInfo("setRoomLevel", maxProx = 0, startPox = -9000, plusSum = 9000, position = 9).apply {
                    callMethod = {
                        val value = (thisProx - plusSum).toShort()
