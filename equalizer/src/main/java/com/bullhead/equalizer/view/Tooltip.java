package com.bullhead.equalizer.view;
/*
...
public class Tooltip extends RelativeLayout{
    ...
    private Tooltip.Alignment mVerticalAlignment = Tooltip.Alignment.CENTER;
    private Tooltip.Alignment mHorizontalAlignment = Tooltip.Alignment.CENTER;
    ...
    public void prepare(Rect rect, float value){
        ...
        if(mHorizontalAlignment == Tooltip.Alignment.RIGHT_LEFT)
            layoutParams.leftMargin = rect.left - width - mRightMargin;
        if(mHorizontalAlignment == Tooltip.Alignment.LEFT_LEFT)
            layoutParams.leftMargin = rect.left + mLeftMargin;
        if(mHorizontalAlignment == Tooltip.Alignment.CENTER)
            layoutParams.leftMargin = rect.centerX() - width/2;
        if(mHorizontalAlignment == Tooltip.Alignment.RIGHT_RIGHT)
            layoutParams.leftMargin = rect.right - width - mRightMargin;
        if(mHorizontalAlignment == Tooltip.Alignment.LEFT_RIGHT)
            layoutParams.leftMargin = rect.right + mLeftMargin;

        // Adjust top coordinate of tooltip based on the Alignment defined
        if(mVerticalAlignment == Tooltip.Alignment.BOTTOM_TOP)
            layoutParams.topMargin = rect.top - height - mBottomMargin;
        else if(mVerticalAlignment == Tooltip.Alignment.TOP_TOP)
            layoutParams.topMargin = rect.top + mTopMargin;
        else if(mVerticalAlignment == Tooltip.Alignment.CENTER)
            layoutParams.topMargin = rect.centerY() - height/2;
        else if (mVerticalAlignment == Tooltip.Alignment.BOTTOM_BOTTOM)
            layoutParams.topMargin = rect.bottom - height - mBottomMargin;
        else if(mVerticalAlignment == Tooltip.Alignment.TOP_BOTTOM)
     ...
     */
    public Tooltip setHorizontalAlignment(Tooltip.Alignment alignment){
     ...
     * @return {@link Tooltip} self-reference.
     */
    public Tooltip setVerticalAlignment(Tooltip.Alignment alignment){
